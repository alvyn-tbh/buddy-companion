                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-lg sm:text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto mb-8">
                            Discover how Buddy AI helps you navigate cultural understanding and meaningful communication through interactive conversations.
                        </p>
                    </motion.div>
                            ...
                            {[
                                {
                                    ...
                                    description: "Unlike traditional language apps, Buddy understands the cultural context behind every conversation.",
                                    highlight: "Cultural intelligence"
                                },
                                {
                                    icon: "🔄",
                                    title: "Interactive Feedback",
                                    description: "Get immediate corrections, suggestions, and cultural insights as you practice conversations.",
                                    highlight: "Real-time guidance"
                                },
                                {
                                    icon: "🎨",
                                    title: "Personalized Scenarios",
                                    description: "Practice situations specific to your goals - whether business, travel, or social interactions.",
                                    highlight: "Tailored learning"
                                },
                                {
                                    icon: "🌐",
                                    title: "Multi-Cultural Perspective",
                                    description: "Learn how the same situation is handled differently across various cultures and regions.",
...
export default CultureHowItWorksPage;
