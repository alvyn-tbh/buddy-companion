        ...
        <section className="pt-24 pb-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid gap-6">
              ...
              >
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">1. Start a Conversation</h2>
              ...
              <motion.div
                ...
                className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl"
              >
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">2. Get Personalized Support</h2>
                <p className="text-lg text-gray-600">
              ...
              <motion.div
                ...
                className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl"
              >
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">3. Find Your Path Forward</h2>
                <p className="text-lg text-gray-600">
